...
funding <- tribble(
  ...
  "Guest teacher", "Holt Middle School, AR", "~30", "2014",
  "Clean-up", "Lake Fayetteville, AR", "Climate Adaptation Postdoctoral Fellows", "2025",
  "Science judge", "University of Florida", "Doctoral Preeminence Fellowship Award", "2019",
  "Guest teacher", "University of Florida", "Robin Nadeau Graduate Research Award", "2019",
  "Tabling", "National Science Foundation", "Research Experience for Undergraduates", "2013",
  "Community science", "National Science Foundation", "Research Experience for Undergraduates", "2012",
  "Conservation education", "Eastern Kentucky University", "Marcia Athey Research Grant", "2016"
)
