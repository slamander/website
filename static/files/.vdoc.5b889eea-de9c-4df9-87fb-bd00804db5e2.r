...
funding <- tribble(
  ...
  "Guest teacher", "Holt Middle School, AR", "~30", "2013",
  "Clean-up", "Lake Fayetteville, AR", "~30", "2013",
  "Science judge", "NWA STEM Fair, AR", "~50", "2013",
  "Guest teacher", "Model Elementary, AR", "~15", "2015",
  "Tabling", "EKU Career Fair, KY", "~150", "2016",
  "Community science", "Water quality testing, KY", "~30", "2016",
  "Conservation education", "Memphis Zoo, TN", "~300", "2018"
)
