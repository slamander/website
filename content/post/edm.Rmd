---
title: Empirical Dynamic Models
...
$$\Large c = \frac{1}{n} \sum_{i=1}^{n} y_{i}$$
...
$$\Large y_{t} = c + b_{1}y_{t-1} + e_{t}$$

Where, $\Large b_1$ is a coefficient of lag 
```{r}
...
$$\Large y_{t} = c + b_{1}y_{t-1} + b_{2}y_{t-1} + e_{t}$$
...
$$\Large y_t = c + b_1y_{t-1} + [...] + b_{j}y_{2-j} + e_t$$
...
$$\Large y_t = c + b_1y_{t-1} + b_2y_{t-12} + e_t$$
