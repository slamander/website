  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        The Qμest lab is led by [**Dr. J Alex Baecher**](/team/admin/) ([⬇️ **CV**](https://drive.google.com/file/d/1nEU0BNcu_OndnVDn8OFAnRdMQCwYPhxe/view?usp=sharing)). We are an applied ecological research group, broadly interested in the processes that determine the distribution of biodiversity in space and time. Our work integrates field studies, laboratory experiments, big data, cutting-edge modeling techniques, and high-performance computing to address questions related to conservation, invasions, disease, and global change. 
