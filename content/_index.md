  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        The Qμest lab is led by [**Dr. J Alex Baecher**](/team/admin/) ([⬇️ **CV**](https://drive.google.com/uc?export=download&id=1AcEL-CGxtrVMFaw9T_ZFc183bzStw2AC)). We are an applied ecological research group, broadly interested in the processes that determine the distribution of biodiversity in space and time. Our work integrates field studies, laboratory experiments, big data, cutting-edge modeling techniques, and high-performance computing to address questions related to conservation, invasions, disease, and global change. 
